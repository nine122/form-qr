...
function App() {
  ...
  const validateForm = () => {
    ...
    if (!formData.couriername.trim()) {
      errors.couriername = "errorMessages.courierRequired";
      isValid = false;
    }
    ...
    if (!cleanedPhone) {
      errors.phonenumber = "errorMessages.phoneRequired";
      isValid = false;
    ...
    if (!formData.numberofpackages || formData.numberofpackages.trim() === "") {
      errors.numberofpackages = "errorMessages.packagesRequired";
      isValid = false;
    }
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          <label>
            ...
            {t("courierName")} <span className="required">*</span>
          </label>
          <input
            type="text"
            name="couriername"
          ...
          {formErrors.couriername && (
            <div className="error-message">{t(formErrors.couriername)}</div>
          )}
        </div>
        ...
        <div className="form-group">
          ...
          {formErrors.phonenumber && (
            <div className="error-message">{t(formErrors.phonenumber)}</div>
          )}
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            <label>
              ...
              {t("numberOfPackages")} <span className="required">*</span>
            </label>
            <input
              type="number"
              ...
              onChange={handleInputChange}
              placeholder={t("numberOfPackages")}
              min="1"
              className="input-field"
            />
            {formErrors.numberofpackages && (
              <div className="error-message">
                {t(formErrors.numberofpackages)}
              </div>
            )}
          </div>
        ...
        <div className="form-group">
          <label>
            ...
            {t("packagePhoto")} <span className="required">*</span>
          </label>
              ...
              imagePreview && (
                <div className="image-preview">
                  <div className="preview-container">
                    <img src={imagePreview} alt={t("packagePhoto")} />
